  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-900 via-gray-800 to-gray-900">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-3 sm:py-4">
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-2">
              ...
              <span className="text-xl sm:text-2xl font-bold text-white">VideoMeet</span>
            </div>
            ...
            {isAuthenticated && user ? (
              ...
              <div className="flex gap-2 sm:gap-4">
                <Link
                  to="/login"
                  className="px-2 py-1 sm:px-4 sm:py-2 text-sm sm:text-base text-gray-300 hover:text-white transition-colors"
                >
                  Войти
                </Link>
                <Link
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-20">
        ...
        {/* Features */}
        <div className="mt-12 sm:mt-24 grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4 sm:gap-8">
          <div className="p-4 sm:p-6 bg-gray-800/50 rounded-lg border border-gray-700">
            ...
            <h3 className="text-lg sm:text-xl font-semibold text-white mb-2">HD Видео</h3>
          ...
          <div className="p-4 sm:p-6 bg-gray-800/50 rounded-lg border border-gray-700">
            ...
            <h3 className="text-lg sm:text-xl font-semibold text-white mb-2">Чат</h3>
            <p className="text-sm sm:text-base text-gray-400">
          ...
          <div className="p-4 sm:p-6 bg-gray-800/50 rounded-lg border border-gray-700">
            ...
            <h3 className="text-lg sm:text-xl font-semibold text-white mb-2">Демонстрация экрана</h3>
            <p className="text-sm sm:text-base text-gray-400">
